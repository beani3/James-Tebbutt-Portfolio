...
public class UFT_StateMachineFSMRBSBT : MonoBehaviour
{
    //creates a dictionary for the states for the FSM
    private Dictionary<Type, UFT_BaseStateFSMRBSBT> states;
    //BaseState = currentState
    public UFT_BaseStateFSMRBSBT currentState;
    ...
    public void SetStates(Dictionary<Type, UFT_BaseStateFSMRBSBT> states)
    {
        this.states = states;
    }
