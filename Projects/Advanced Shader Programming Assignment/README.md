# Advanced Shader Programming Assignment
### Project Overview
...
---
### What I Learned
- PBR (Physics-Based Lighting).
- Shadow mapping.
- To use Compute Shaders and noise algorithms to generate procedural terrain with per-vertex normals.
