...
private:
	...
	*/
	...
	inline static uint32_t s_currGeoID{ std::numeric_limits<uint32_t>::max() }; //!< Static variable to track which geometry is currently bound, used to avoid redundant binds
};